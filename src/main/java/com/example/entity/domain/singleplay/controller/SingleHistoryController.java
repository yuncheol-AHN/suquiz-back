package com.example.entity.domain.singleplay.controller;

import com.example.entity.domain.singleplay.dto.SingleHistoryDto;
import com.example.entity.domain.singleplay.service.SingleHistoryService;
...
//    private final Word
    ...
    @GetMapping("/isSolved")
    public ResponseEntity<CommonResponse> isSolved(@RequestParam(value = "userId") String email) {
